...
Original file is located at
    https://colab.research.google.com/drive/1lBKVVRKR6AKVumIbVupgCmR4PdKADrhI

# Hãy làm mọi cách để f1_score trên tập test >=87%
=> Không được dùng CNN , chỉ được dùng mạng NN
-
